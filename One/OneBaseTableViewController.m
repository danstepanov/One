//
//  Formerly XHBaseTableViewController.m
...
@interface OneBaseTableViewController ()
...
- (UITableView *)tableView {
    if (!_tableView) {
        ...
        tableViewFrame.size.height -= (self.navigationController.viewControllers.count > 1 ? 0 : (CGRectGetHeight(self.tabBarController.tabBar.bounds))) + [OneFoundationCommon getAdapterHeight];
